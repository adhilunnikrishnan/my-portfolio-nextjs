  ...
  return (
    ...
    >
      ...
      <div
        ...
        className="relative flex h-[320px] cursor-text flex-col overflow-hidden rounded-lg border border-border/50 bg-background/95 shadow-2xl backdrop-blur-xl transition-shadow hover:border-accent/40 sm:h-[380px]"
      >
